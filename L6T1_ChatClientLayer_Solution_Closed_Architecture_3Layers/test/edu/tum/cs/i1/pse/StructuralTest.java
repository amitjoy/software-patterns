 ...
 * Version 1.1
 *
 * Fixed bug, where methods with 0 parameters were always accepted
 * Also checks for private methods now
 *
 */
...
public class StructuralTest {
    ...
    // FIXME: Overloaded methods not supported: Currently this method just picks
    // the first method, that has the proper name. This might lead to a test,
    ...
    throws NoSuchMethodException {
        ...
        while (methodsIterator.hasNext()) {
            ...
            //TODO: put actual parameter list directly here to safe some code and make it more stable
            Method actualMethod = clazz.getDeclaredMethod(methodName, null);
            ...
            assertEquals("Wrong amount of parameters in method " + methodName + ".", expectedParameters.length(), parameterTypes.length); 
